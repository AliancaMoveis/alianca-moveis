...
const usuarios = [
  ...
  [14, "Suporte — Carla", ["suporte_consultores"], false], [15, "Projetista — Roy", ["atendente_cliente"], true], [16, "Projetista — Giovanna", ["atendente_cliente"], true], [6, "Supervisão", ["supervisao"], false], [17, "Vânia", ["posvenda"], false],
...
const setores = [
  ...
  ["suporte_consultores", "Suporte Consultores Externos", L()], ["atendente_cliente", "Projetista (loja)", L()], ["posvenda", "Pós-venda Projetados", L(true)],
