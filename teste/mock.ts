...
const usuarios = [
  ...
  [14, "Suporte — Carla", ["suporte_consultores"], false], [15, "Projetista — Roy", ["atendente_cliente"], true], [16, "Projetista — Giovanna", ["atendente_cliente"], true], [6, "Supervisão", ["supervisao"], false],
...
const setores = [
  ...
  ["suporte_consultores", "Suporte Consultores Externos", L()], ["atendente_cliente", "Projetista (loja)", L()],
...
const tipos: any = {
  ...
  agendamento_loja: { nome: "Agendamento direto na loja", destino: "suporte_consultores", anexos: true, presale: true, direto: true }, outros: { nome: "Outros", destino: "callcenter" },
};
